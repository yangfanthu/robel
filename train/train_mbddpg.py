...
if __name__ == "__main__":
    ...
    state_dim = base_env.reset().shape[0] - 9
    ...
    adversarial_env.ddpg.load_pretrained_model()
    ...
    while True:
        ...
        for i in range(args.ddpg_training_steps):
            ...
            adversarial_env.ddpg.add_model_buffer(current_state, action, next_state, reward, done)
            if ddpg_t > args.start_timesteps:
